...
// Group 2
// Demo 1
// This code moves to a desired foot amount in a straight line.
...
double Kpl = 2.1;    // V/rad
double Kil = 0.02;// 0.08; //.1; // V/rad*sec
double Kdl = 0; //0.1;//0.1; //.1; // V/(rad/sec)

double Kpr = 2.1;    // V/rad
double Kir = 0.01;//0.07; //.1; // V/rad*sec
...
double distance = 12.0*4.0*6.283185307 / (18.2);
double e = 0;
double er = 0;
...
void loop() {  
  ...
  // }
   ...
   //Serial.print(u);
   //Serial.println();
   controlr = (ur / umax) * 225; // Making input between 0-255
   //Serial.print("Motor Command: "); // For Debugging
   //Serial.print(control);
   //Serial.println();
