...
double angleReceived=0;
double distanceReceived=0;
int endAng=0;
String PositionAndAngleData;
bool dataReceived=0;
   ...
   if ((angle == angleD) && (abs(e) < 0.2) && (abs(er) < 0.2)) {
    ...
    if(!dataReceived){
      ...
      dataReceived=1;   
       ...
       // convert PositionAndAngleData from string to an int, do stuff
       int i=0;
//   
//    while (PositionAndAngleData[i] != "D"){ //inf loop somehow
